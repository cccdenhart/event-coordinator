defmodule FinalProjectWeb.EventControllerTest do
  use FinalProjectWeb.ConnCase

  alias FinalProject.Events

  @create_attrs %{is_open: true, location: "some location", rating: 120.5, title: "some title"}
  @update_attrs %{is_open: false, location: "some updated location", rating: 456.7, title: "some updated title"}
  @invalid_attrs %{is_open: nil, location: nil, rating: nil, title: nil}
